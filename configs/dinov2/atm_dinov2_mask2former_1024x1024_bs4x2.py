...
_base_ = [
    ...
    # "../_base_/datasets/rain-acdc_1024x1024.py",
    "../_base_/default_runtime.py",
    "../_base_/models/atm_dinov2_mask2former.py",
]
crop_size = (1024, 1024)
model = dict(
    backbone=dict(
...
train_cfg = dict(type="IterBasedTrainLoop", max_iters=40000, val_interval=20000)
