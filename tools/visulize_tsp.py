...
def parse_args():
    ...
    parser.add_argument("checkpoint", help="Path to the checkpoint file for both the atm and head models.")
    ...
    parser.add_argument("--save_dir", default="work_dirs/show_zhijietsp_1024_3", help="Directory to save the output images. Default is 'work_dirs/show'.")
